...
def insert_picture_in_gif(gif, ins_pic, coords) -> io.BytesIO:
        ...
        lower right coords of the the image to be inserted on each frame as a 
        collection of 4-tuples `coords`. Both `ins_pic` and `gif` must be able 
        to be passed to Pillow's image open function (ex.: a path or byte 
